<?php
$home_procat_phongtam = $action_product->getProductList_byMultiLevel_orderProductId(487, 'desc','', 3,'');
$lis = $action -> getDetail('productcat', 'productcat_id',487);
?>
...
<div class="gb-producttab-home_mptoto slide11">
    <div class="container">
        ...
        <div class="row">
            <div class="gb-slideshow_mptoto-slide102 owl-carousel owl-theme wow slideInUp" data-wow-duration="1s">
            <!-- Bồn cầu -->
...
<script>
    $(document).ready(function (){
        $('.gb-slideshow_mptoto-slide102').owlCarousel({
            loop:true,
            margin:30,
            navSpeed:500,
            nav:true,
