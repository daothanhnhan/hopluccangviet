...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Banner Website</span>
        ...
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                ?>
                    <img src="../images/<?= $rowConfig['banner1']?>" class="img-responsive" alt="Image" width="300">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Link POPUP</p>
            ...
            <p class="titleRightNCP">Facebook</p>
            <input type="text" class="txtNCP1" value="<?php echo $row_showMain['facebook']?>" name="facebook"/>

            <p class="titleRightNCP">Youtube</p>
            <input type="text" class="txtNCP1" value='<?php echo $row_showMain['youtube']?>' name="youtube"/>

            <p class="titleRightNCP">Twitter</p>
            <input type="text" class="txtNCP1" value="<?php echo $row_showMain['twitter']?>" name="twitter"/>

            <p class="titleRightNCP">Google</p>
            <input type="text" class="txtNCP1" value="<?php echo $row_showMain['google']?>" name="google"/>
        </div>
    </div><!--end rowNodeContentPage-->
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Đường dẫn slide và banner</span>
            <p class="subLeftNCP">Nội dung thông tin đường dẫn</p>   
        </div>
        <div class="boxNodeContentPage">

            <p class="titleRightNCP">Link Slide 1</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link_slide1']?>" name="link_slide1"/>

            <p class="titleRightNCP">Link Slide 2</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link_slide2']?>" name="link_slide2"/>

            <p class="titleRightNCP">Link Slide 3</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link_slide3']?>" name="link_slide3"/>

            <p class="titleRightNCP">Link Banner</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link_banner']?>" name="link_banner"/>
