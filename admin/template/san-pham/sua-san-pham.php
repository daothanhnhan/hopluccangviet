...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor2" name="product_des2"><?php echo $row_showMain['lang_product_des2'];?></textarea></p>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Ảnh đại diện Video</span>

            <p class="subLeftNCP">Thiết lập ảnh đại diện Video</p>

        </div>

        <div class="boxNodeContentPage">

            <h3>Ảnh đại diện Video</h3>

            <div id="wrapper">

                <input id="fileUpload" type="file" name="fileUpload4" />
                ...
                <div id="image-holder">
                    ...
                    <?php 
                        ...
                        if ($row['product_img_video'] != '') {

                        ?>

                            <img src="../images/<?= $row['product_img_video']?>" class="img-responsive" alt="Image">

                            <input type="hidden" name="product_img_video" value="<?= $row['product_img_video']?>">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Ảnh đại diện sản phẩm</span>
        ...
        <div class="boxNodeContentPage">
            ...
            <div id="wrapper">
                ...
                <input id="fileUpload" type="file" name="fileUpload3" onchange="showImage(this)" />
                ...
                <div id="image-holder">
                    ...
                    <?php 
                        ...
                        if ($row['product_img_2'] != '') {

                        ?>

                            <img src="../images/<?= $row['product_img_2']?>" class="img-responsive" alt="Image">

                            <input type="hidden" name="product_img_2" value="<?= $row['product_img_2']?>">
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent" >
                    ...
                    <select name="product_material" class="txtNCP1">
                        <?php foreach ($thuong_hieu as $item) { ?>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="number" class="txtNCP1" placeholder="Nhập sắp xếp" name="product_sort" value="<?php echo $row['product_sort'];?>"/>
            ...
            <div>
             ...
             <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_sale" <?= $row['product_sale'] == 1 ? 'checked' : '' ?>>Sản phẩm khuyến mãi
