            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    case 'lien-he':
                        ...
                        break;
                    case 'xoa-lien-he':
                        include_once('template/xoa-lien-he.php');
                        break;
                    //////////////Slider///////////////////
                    case "slider":
                    ...
                    ///////////// giá phần trăm ///////////
                    case "price-percent":
                        include_once("template/price-percent/price-percent.php");
                        break;
                    case "them-price-percent":
                        include_once("template/price-percent/them-price-percent.php");
                        break;
                    case "sua-price-percent":
                        include_once("template/price-percent/sua-price-percent.php");
                        break;
                    case "xoa-price-percent":
                        include_once("template/price-percent/xoa-price-percent.php");
                        break;
                    //////////// khoang gia ///////////////
                    case "khoang-gia":
                        include_once("template/khoang-gia/khoang-gia.php");
                        break;
                    case "them-khoang-gia":
                        include_once("template/khoang-gia/them-khoang-gia.php");
                        break;
                    case "sua-khoang-gia":
                        include_once("template/khoang-gia/sua-khoang-gia.php");
                        break;
                    case "xoa-khoang-gia":
                        include_once("template/khoang-gia/xoa-khoang-gia.php");
                        break;
                    ///////////// dang ky /////////////////
                    case "nhan-khuyen-mai":
                        include_once("template/dang-ky/nhan-khuyen-mai.php");
                        break;
                    /////////////// nhận tin //////////////
                    // case "nhan-tin":
