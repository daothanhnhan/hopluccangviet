...
<div id="divWrapper">
    <div class="coverFormLogin">
        <form method="post" class="formLogin" id="formLogin">
            ...
            <img src="image/logo.png" alt="Cafe Link Việt Nam" class="logoLogin" /> 
            <div class="boxForm">
        ...
        <p class="endLogin">Công ty TNHH Phát Triển Thương Hiệu Cafe Link Việt Nam<br /><em style="text-decoration:underline;">Điện thoại:</em> <strong>0865.689.886</strong> - <em style="text-decoration:underline;">Email:</em> <strong>kinhdoanh@cafelink.org</strong><br /><em style="text-decoration:underline;">Website:</em> cafelink.org</p>
