          ...
          <!--  <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=dich-vu" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dich-vu' || $_GET["page"] == 'them-dich-vu' || $_GET["page"] == 'sua-dich-vu') {
                       echo 'sltMenu';
                   } ?>"><img src="image/news2.png" class="iconMenu2"/><img src="image/news.png" class="iconMenu"/>Video</a></li>
            ...
            <li><a href="index.php?page=nhan-khuyen-mai" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhận khuyến mãi</a>
            </li>

            <li><a href="index.php?page=thuong-hieu" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Thương hiệu</a>
            </li>

            <li><a href="index.php?page=price-percent" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Giá phần trăm</a>
            </li>

            <!-- <li><a href="index.php?page=khoang-gia" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Khoảng giá</a>
            </li> -->
            ...
            <!-- <li><a href="index.php?page=thuong-hieu" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dang-ky' || $_GET["page"] == 'them-dang-ky' || $_GET["page"] == 'sua-dang-ky') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Ưu đãi</a></li> -->
...
<div class="logoTop">
    <a href="/admin/" class="linkLogoTop"><img src="image/logo.png" class="imgLogoTop"/></a>
