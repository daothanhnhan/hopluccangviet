...
public function getProductList_byMultiLevel_orderProductId($idProductCat,$order_productId,$trang, $limit, $page){
    ...
    //             $whereClause .= ') '.$price_filter.' order by product_sort asc, product_id desc';
    //         }
    //         if ($_SESSION['sort_price'] == 'az') {
    //             $whereClause .= ') '.$price_filter.' order by product_sort asc, product_name asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_asc') {
    //             $whereClause .= ') '.$price_filter.' order by product_sort asc, product_price asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_desc') {
    //             $whereClause .= ') '.$price_filter.' order by product_sort asc, product_price desc ';
    //         }
    //     } else {
    //         $material = $_SESSION['material'];
    //         if ($_SESSION['sort_price'] == 'default') {
    //             $whereClause .= ') '.$price_filter.' and product_material = "'.$material.'" order by product_sort asc, product_id desc';
    //         }
    //         if ($_SESSION['sort_price'] == 'az') {
    //             $whereClause .= ') '.$price_filter.' and product_material = "'.$material.'" order by product_sort asc, product_name asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_asc') {
    //             $whereClause .= ') '.$price_filter.' and product_material = "'.$material.'" order by product_sort asc, product_price asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_desc') {
    //             $whereClause .= ') '.$price_filter.' and product_material = "'.$material.'" order by product_sort asc, product_price desc ';
    //         }
    //     }
    // } else {
    ...
    //     if ($_SESSION['material'] == '') {
    //         if ($_SESSION['sort_price'] == 'default') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" order by product_sort asc, product_id desc';
    //         }
    //         if ($_SESSION['sort_price'] == 'az') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" order by product_sort asc, product_name asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_asc') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" order by product_sort asc, product_price asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_desc') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" order by product_sort asc, product_price desc ';
    //         }
    //     } else {
    //         $material = $_SESSION['material'];
    //         if ($_SESSION['sort_price'] == 'default') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" and product_material = "'.$material.'" order by product_sort asc, product_id desc';
    //         }
    //         if ($_SESSION['sort_price'] == 'az') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" and product_material = "'.$material.'" order by product_sort asc, product_name asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_asc') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" and product_material = "'.$material.'" order by product_sort asc, product_price asc ';
    //         }
    //         if ($_SESSION['sort_price'] == 'price_desc') {
    //             $whereClause .= ') '.$price_filter.' and product_expiration = "'.$brand.'" and product_material = "'.$material.'" order by product_sort asc, product_price desc ';
    //         }
    //     }
    // }
    ...
    if (!empty($_SESSION['brand'])) {
        $brand = $_SESSION['brand'];
        $whereClause .= " AND product_material = '$brand' ";
    }

    if (!empty($_SESSION['price_percent'])) {
        $price_percent = $_SESSION['price_percent'];
        $whereClause .= " AND product_price_sale = '$price_percent' ";
    }

    if (!empty($_SESSION['price_khoang'])) {
        $price_khoang = $_SESSION['price_khoang'];
        if ($price_khoang == 1) {
            $khoang_gia = " AND product_price < 1,000,000";
        }
        if ($price_khoang == 2) {
            $khoang_gia = " AND product_price >= 1,000,000 AND product_price < 5,000,000";
        }
        if ($price_khoang == 3) {
            $khoang_gia = " AND product_price >= 5,000,000 AND product_price < 10,000,000";
        }
        if ($price_khoang == 4) {
            $khoang_gia = " AND product_price >= 10,000,000 AND product_price < 50,000,000";
        }
        if ($price_khoang == 5) {
            $khoang_gia = " AND product_price >= 50,000,000 AND product_price < 100,000,000";
        }
        if ($price_khoang == 6) {
            $khoang_gia = " AND product_price >= 100,000,000";
        }

        $khoang_gia = str_replace(",", "", $khoang_gia);

        $whereClause .= $khoang_gia;
    }
...
public function getProductCat_byProductCatIdParent($idProductCatParent,$order_productCatId){
    ...
    $where = "where $nameColIdProductParent = '".$idProductCatParent."' AND state = 1 ";

    $order = "order by productcat_sort_order $order_productCatId";
...
public function getListProductRelate_byIdCat_hasLimit($idProductCat,$limit){
    ...
    $sql = "SELECT * from $table $where order by product_id desc $limit";    
    $result = mysqli_query($conn_vn,$sql);
    while($row = mysqli_fetch_array($result)){
        $rows[] = $row;
    }
...
public function getExpirationAll(){
    global $conn_vn;
    $table = $this->nameTable_product;
    ...
    $sql = "SELECT product_expiration  from $table $orderby";
    // echo $sql;
    $result = mysqli_query($conn_vn,$sql);
    while($row = mysqli_fetch_array($result)){
        $rows[] = $row;
...
public function getProductList_byMultiLevel_orderProductId_tu($idProductCat,$order_productId,$trang, $limit, $page){
    ...
    if ($_SESSION['brand'] == "") {
        if ($_SESSION['price']['max'] == "") {
            $whereClause .= ")";
        } else {
            $whereClause .= ") AND product_price BETWEEN ".$_SESSION['price']['be']." and ".$_SESSION['price']['lon'];
        }
        
    } else {
        if ($_SESSION['price']['max'] == "") {
            $whereClause .= ") AND product_expiration = '".$_SESSION['brand']."'";
        } else {
            $whereClause .= ") AND product_expiration = '".$_SESSION['brand']."' AND product_price BETWEEN ".$_SESSION['price']['be']." and ".$_SESSION['price']['lon'];
        }
...
public function getProductList_byMultiLevel_orderProductId_brand($idProductCat,$order_productId,$trang, $limit, $page){
    ...
    if ($_SESSION['brand'] == "") {
        if ($_SESSION['material'] == "") {
            ...
            $whereClause .= ") AND product_material = '".$_SESSION['material']."'";
        }
        ...
        if ($_SESSION['material'] == "") {
            ...
            $whereClause .= ") AND product_expiration = '".$_SESSION['brand']."' AND product_material = '".$_SESSION['material']."'";
        }
