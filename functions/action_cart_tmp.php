      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     $message = '<label class="text-success">Đã xóa sản phẩm</label>';  
                }  
           }  
      }  
      ...
      {  
           ...
           {  
                $order_table .= '  
                     <tr>  
                          ...
                          <td align="right">'.number_format($values["product_quantity"] * $values["product_price"], 0).' VNĐ</td>  
                          <td><button name="delete" class="btn btn-danger btn-xs delete" id="'.$values["product_id"].'">Xóa sản phẩm</button></td>  
                     </tr>  
                ';  
           ...
           $order_table .= '  
                <tr>  
                     ...
                     <td align="right">'.number_format($total, 0).' VNĐ</td>  
                     <td></td>  
                </tr>  
                <tr>  
                     <td colspan="5" align="center">  
                          <form method="post" action="/cart-payment">  
                               <input type="submit" name="place_order" class="btn btn-warning" value="Thanh toán" />  
                          </form>  
                     </td>  
                </tr>  
           ';  
